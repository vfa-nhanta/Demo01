...
import Vector from '../BasketBallComponent/Vector';
import Net from '../BasketBallComponent/Net';
import Ball from '../BasketBallComponent/Ball';
import Emoji from '../BasketBallComponent/Emoji';
import Floor from '../BasketBallComponent/Floor';
import Hoop from '../BasketBallComponent/Hoop';
import Score from '../BasketBallComponent/Score';
...
export default class BasketballScreen extends Component {
    ...
    return (
      ...
      <View style={styles.btnView}>
        ...
        <TouchableOpacity 
            ...
            onPress={() => this.restartBtnHandler()}>
